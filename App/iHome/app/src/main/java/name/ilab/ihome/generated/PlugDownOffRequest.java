...
"PlugDownOffRequest": "PlugDownOffRequest": {
  "method": "GET",
  "fullUrl": "http://192.168.1.126/down/off",
  "url": "down/off",
...
public class PlugDownOffRequest extends HttpRequest {

    public static final String API_NAME =
            "name.ilab.ihome.generated.PlugDownOffRequest";
    ...
    public class Request {
        ...
        private void generateUrl() {
            if (url == null) {
                url = "http://192.168.1.126/down/off";
    ...
    public PlugDownOffRequest() {
        this.request = new Request();
        this.responseType = ResponseType.TEXT;
    }

    public PlugDownOffRequest go(IHttpClient httpClient) {
