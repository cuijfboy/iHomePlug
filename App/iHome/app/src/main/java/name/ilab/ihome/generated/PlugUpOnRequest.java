...
"PlugUpOnRequest": "PlugUpOnRequest": {
  "method": "GET",
  "fullUrl": "http://192.168.1.126/up/on",
  "url": "up/on",
...
public class PlugUpOnRequest extends HttpRequest {

    public static final String API_NAME =
            "name.ilab.ihome.generated.PlugUpOnRequest";
    ...
    public PlugUpOnRequest() {
        this.request = new Request();
        this.responseType = ResponseType.TEXT;
    }

    public PlugUpOnRequest go(IHttpClient httpClient) {
