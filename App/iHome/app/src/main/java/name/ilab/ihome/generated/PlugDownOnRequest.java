...
"PlugDownOnRequest": "PlugDownOnRequest": {
  "method": "GET",
  "fullUrl": "http://192.168.1.126/down/on",
  "url": "down/on",
...
public class PlugDownOnRequest extends HttpRequest {

    public static final String API_NAME =
            "name.ilab.ihome.generated.PlugDownOnRequest";
    ...
    public class Request {
        ...
        private void generateUrl() {
            if (url == null) {
                url = "http://192.168.1.126/down/on";
    ...
    public PlugDownOnRequest() {
        this.request = new Request();
        this.responseType = ResponseType.TEXT;
    }

    public PlugDownOnRequest go(IHttpClient httpClient) {
